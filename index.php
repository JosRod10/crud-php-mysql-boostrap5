            ...
            <div class="col-md-12">
                <h1 class="text-center">
                    ...
                    <span class="float-end">
                        <a href="acciones/exportarExcel.php" class="btn btn-success" title="Exportar a Excel" download="empleados.csv"><i class="bi bi-file-earmark-spreadsheet"></i></a>
                    </span>
                    <span class="float-end">
                        <a href="acciones/exportar.php" class="btn btn-warning" title="Exportar a CSV" download="empleados.csv"><i class="bi bi-filetype-csv"></i></a>
                    </span>
                    <hr>
                </h1>
                <?php
